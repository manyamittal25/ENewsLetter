      ...
      <div className="w-[95%] mx-auto pb-10 flex flex-col text-center space-y-4 md:flex-row md:justify-between md:items-center md:space-y-0 border-white-4 border-t-2 mt-20">
        <div className="flex flex-col sm:flex-row justify-between items-center text-center sm:text-left">
          ...
          <div className="flex justify-center space-x-4 mt-4">
            ...
            <a href="https://www.linkedin.com/in/manya-mittal-815235258/" className="text-white"><FaLinkedinIn /></a>
            <a href="https://github.com/manyamittal25" className="text-white"><FaGithub /></a>
          </div>
        </div>
      </footer>
  );
