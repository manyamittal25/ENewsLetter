      ...
      {isOpen && (
        <div className="absolute w-[90%] bg-black text-white shadow-lg rounded-lg py-6 px-5 top-20 justify-center">
          <ul className="flex flex-col gap-3">
            ...
            <li>
              <button onClick={() => toggleMenu('buzzletter')} className="border-b border-gray-200 w-full text-left flex items-center justify-between py-2 font-semibold">
                BUZZLETTER FOR {activeMenu === 'buzzletter' ? <FaChevronUp /> : <FaChevronDown />}
              </button>
              {activeMenu === 'buzzletter' && (
                <ul className="pl-4 mt-2">
